...
const file_product_proto_rawDesc = "" +
	...
	"\x05price\x18\x04 \x01(\x01R\x05price2N\n" +
	"\x0eProductService\x12<\n" +
	"\n" +
	"GetProduct\x12\x17.product.ProductRequest\x1a\x15.product.ProductReplyB\x0eZ\f../productpbb\x06proto3"
...
var file_product_proto_goTypes = []any{
	...
	(*ProductReply)(nil),   // 1: product.ProductReply
}
var file_product_proto_depIdxs = []int32{
	0, // 0: product.ProductService.GetProduct:input_type -> product.ProductRequest
	1, // 1: product.ProductService.GetProduct:output_type -> product.ProductReply
